...
class TeamsServiceStub extends ITeamsService {
  ...
  Team _generateTeam(String suf, {String profSuf: "1"}) {
    switch (suf) {
      case "1":
        return _generateTeamOwn(suf);
      case "2":
        return _generateTeamMember(suf);
      case "3":
        return _generateTeamApplied(suf);
      case "4":
        return _generateTeamInvitation(suf);
      case "5":
        return _generateTeamGeneral(suf);
      default:
        return _generateTeamDefault(suf);
    }
  }
